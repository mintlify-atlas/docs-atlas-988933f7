...
description: "Manage browser sessions, pages, and saved authentication profiles."
---
...
<Tree>
  <Tree.Folder name=".libretto" defaultOpen>
    <Tree.Folder name="sessions" defaultOpen>
      <Tree.Folder name="<session>" defaultOpen>
        <Tree.File name="state.json" />
        <Tree.File name="logs.jsonl" />
        <Tree.File name="network.jsonl" />
        <Tree.File name="actions.jsonl" />
...
<CardGroup cols={2}>
  <Card title="open & connect" icon="browser" href="/cli/open-and-connect">
    Start a session after init completes.
  </Card>
  <Card title="network & actions" icon="chart-network" href="/cli/network-and-actions">
