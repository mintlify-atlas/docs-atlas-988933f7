...
description: "Ask your agent to explore a site and generate a complete browser automation script."
---
...
<CardGroup cols={2}>
  <Card title="Interactive script building" href="/guides/interactive-script-building">
    Show the agent your workflow manually and let it turn your actions into code.
  </Card>
  <Card title="Convert to network requests" href="/guides/convert-to-network-requests">
