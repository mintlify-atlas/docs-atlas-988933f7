---
title: "Bot detection"
description: "Understand how sites detect automation and choose approaches that minimize detection risk."
---
...
<Columns cols={2}>
  <Card title="Automation approaches" icon="code" href="/guides/automation-approaches">
