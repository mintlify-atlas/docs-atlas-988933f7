...
description: "Record your actions in the browser and let your agent turn them into automation code."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Debugging workflows" href="/guides/debugging-workflows">
