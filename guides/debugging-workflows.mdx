...
description: "Reproduce failures, inspect live page state, and fix broken browser automations."
---
...
<CardGroup cols={2}>
  <Card title="One-shot script generation" href="/guides/one-shot-script-generation">
