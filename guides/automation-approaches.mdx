...
description: "Choose the right integration strategy: Playwright UI, passive interception, in-browser fetch, or direct HTTP."
---
...
<Columns cols={2}>
  ...
  <Card title="Sessions and profiles" icon="user" href="/guides/sessions-and-profiles">
